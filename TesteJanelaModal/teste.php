        ...
        <nav class="cadastro2">
            ...
            <nav class="forms">
                ...
                <div class="modal">
                    <div class="content">
                        <form>
                        <label for="name">Nome do jogo:</label><br>
                        <input type="text" id="name" name="gamename"><br>
                        <label for="value">Nickname:</label><br>
                        <input type="text" id="value" name="gamevalue"><br>
                        <input type="file" id="file" name="gamefile"><br>
                        </form>
                    </div>
                </div>
                <button class="modalBtn">Cadastrar Jogo</button>
